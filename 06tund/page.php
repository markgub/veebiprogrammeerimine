<?php
	...
	if(isset($_POST["submitUserData"])){
		...
		if(isset($_POST["password"]) and !empty($_POST["password"]) or strlen($_POST["password"])){
		} else {
...
?>
	...
	<body> <!--See, mis on näha lehel, kohustuslike elemente pole-->
		...
		<h2> Loo kasutaja</h2>
		<p>Loo endale meie lehe <a target="_blank" href="NewUser.php">kasutajakonto!</a></p>
		<hr>
		<?php
		echo $randomImgHTML;
		?>
